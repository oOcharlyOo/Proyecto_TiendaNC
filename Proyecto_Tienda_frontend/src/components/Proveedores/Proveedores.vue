...
.proveedores-container :deep(.proveedores-grid){display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:.75rem}.proveedores-container :deep(.proveedor-card){background:var(--color-bg-secondary);border:none;border-radius:14px;border-top:3px solid var(--color-accent);padding:.9rem;display:flex;flex-direction:column;gap:.55rem;box-shadow:3px 3px 10px rgba(0,0,0,.08),inset 0 1px 0 rgba(255,255,255,.04);transition:all .2s ease;position:relative;overflow:hidden}.proveedores-container :deep(.proveedor-card::after){content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,transparent,var(--color-accent),transparent);opacity:0;transition:opacity .2s}.proveedores-container :deep(.proveedor-card:hover){transform:translateY(-3px);box-shadow:6px 6px 18px rgba(0,0,0,.15),0 0 0 1px color-mix(in srgb,var(--color-accent) 20%,transparent)}.proveedores-container :deep(.proveedor-card:hover::after){opacity:1}.proveedores-container :deep(.prov-card-top){display:flex;align-items:center;justify-content:space-between;padding-bottom:.45rem;border-bottom:1px dashed color-mix(in srgb,var(--color-border) 60%,transparent)}.proveedores-container :deep(.prov-card-avatar){width:42px;height:42px;border-radius:12px;background:linear-gradient(135deg,color-mix(in srgb,var(--color-accent) 18%,transparent),color-mix(in srgb,var(--color-accent) 6%,transparent));display:flex;align-items:center;justify-content:center;font-weight:900;font-size:.95rem;color:var(--color-accent);box-shadow:2px 2px 6px rgba(0,0,0,.1),inset 0 1px 0 rgba(255,255,255,.08);transition:all .2s}.proveedores-container :deep(.proveedor-card:hover .prov-card-avatar){box-shadow:3px 3px 8px rgba(0,0,0,.15),0 0 12px color-mix(in srgb,var(--color-accent) 20%,transparent)}.proveedores-container :deep(.prov-card-tipo){font-size:.58rem;padding:.15rem .5rem;border-radius:6px;font-weight:700;letter-spacing:.03em;text-transform:uppercase}.proveedores-container :deep(.tipo-preventa){background:linear-gradient(135deg,color-mix(in srgb,var(--color-info) 20%,transparent),color-mix(in srgb,var(--color-info) 8%,transparent));color:var(--color-info);box-shadow:1px 1px 3px rgba(0,0,0,.06)}.proveedores-container :deep(.tipo-directa){background:linear-gradient(135deg,color-mix(in srgb,var(--color-success) 20%,transparent),color-mix(in srgb,var(--color-success) 8%,transparent));color:var(--color-success);box-shadow:1px 1px 3px rgba(0,0,0,.06)}.proveedores-container :deep(.prov-card-name){margin:0;font-size:.88rem;font-weight:800;color:var(--color-text-primary);letter-spacing:-.01em}.proveedores-container :deep(.prov-card-days){display:flex;gap:.35rem;flex-wrap:wrap}.proveedores-container :deep(.day-badge){font-size:.58rem;padding:.12rem .4rem;border-radius:5px;font-weight:700;display:inline-flex;align-items:center;gap:.2rem}.proveedores-container :deep(.day-pedido){background:color-mix(in srgb,var(--color-accent) 12%,transparent);color:var(--color-accent);border:1px solid color-mix(in srgb,var(--color-accent) 15%,transparent)}.proveedores-container :deep(.day-entrega){background:color-mix(in srgb,var(--color-info) 12%,transparent);color:var(--color-info);border:1px solid color-mix(in srgb,var(--color-info) 15%,transparent)}.proveedores-container :deep(.prov-card-contact){display:flex;flex-direction:column;gap:.15rem;font-size:.65rem;color:var(--color-text-secondary);padding-top:.1rem}.proveedores-container :deep(.contact-line){display:flex;align-items:center;gap:.3rem;transition:color .15s}.proveedores-container :deep(.contact-line:hover){color:var(--color-text-primary)}.proveedores-container :deep(.prov-card-address),.proveedores-container :deep(.prov-card-notes){font-size:.62rem;color:var(--color-text-secondary);opacity:.75;padding-left:.1rem}.proveedores-container :deep(.prov-card-actions){display:flex;gap:.4rem;padding-top:.4rem;border-top:1px solid color-mix(in srgb,var(--color-border) 50%,transparent)}.proveedores-container :deep(.btn-card-edit){flex:1;padding:.4rem;border:none;border-radius:8px;background:color-mix(in srgb,var(--color-accent) 10%,transparent);color:var(--color-accent);font-size:.65rem;font-weight:700;cursor:pointer;box-shadow:1px 1px 3px rgba(0,0,0,.05);transition:all .15s;letter-spacing:.02em}.proveedores-container :deep(.btn-card-edit:hover){background:var(--color-accent);color:var(--color-on-brand);box-shadow:2px 2px 6px rgba(0,0,0,.15);transform:translateY(-1px)}.proveedores-container :deep(.btn-card-delete){flex:1;padding:.4rem;border:none;border-radius:8px;background:color-mix(in srgb,var(--color-error) 8%,transparent);color:var(--color-error);font-size:.65rem;font-weight:700;cursor:pointer;box-shadow:1px 1px 3px rgba(0,0,0,.05);transition:all .15s;letter-spacing:.02em}.proveedores-container :deep(.btn-card-delete:hover){background:var(--color-error);color:#fff;box-shadow:2px 2px 6px rgba(0,0,0,.15);transform:translateY(-1px)}
