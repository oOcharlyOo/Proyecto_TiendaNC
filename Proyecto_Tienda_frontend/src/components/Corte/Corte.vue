...
<template>
  <div class="corte-view">
    ...
    <CorteDailyModal
      ...
      :totalEnvase="totalEnvase"
      :reporteTitulo="reporteTitulo"
      :tipoGraficaDiaria="tipoGraficaDiaria"
      :productosDiario="productosDiario"
      :productosUnitariosDiario="productosUnitariosDiario"
      :productosGranelDiario="productosGranelDiario"
      :chartDataDiarioCombinado="chartDataDiarioCombinado"
      :chartDataDiarioUnitarios="chartDataDiarioUnitarios"
      :chartDataDiarioGranel="chartDataDiarioGranel"
      :chartOptionsDiarioCombinado="chartOptionsDiarioCombinado"
      :chartOptionsDiarioUnitarios="chartOptionsDiarioUnitarios"
      :chartOptionsDiarioGranel="chartOptionsDiarioGranel"
      :chartOptionsDiarioDoughnut="chartOptionsDiarioDoughnut"
      :diarioPieChartData="diarioPieChartData"
      :diarioPieChartOptions="diarioPieChartOptions"
      :uniqueHorariosDiario="uniqueHorariosDiario"
      :detallesDiario="detallesDiario"
      :formatoMoneda="formatoMoneda"
      :formatearCantidad="formatearCantidad"
      ...
      @cambiar-tipo-grafica="(t) => { tipoGraficaDiaria = t }"
